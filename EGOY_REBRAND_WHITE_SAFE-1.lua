...
local t1 = {
	...
	Credits = "Thanks to all my Discord members",
        ...
        do
            ...
            t2 = {
				Dark = {
					...
					rail = Color3.fromRGB(255, 255, 255),
					card = Color3.fromRGB(255, 255, 255),
					lift = Color3.fromRGB(245, 245, 245),
					fill = Color3.fromRGB(238, 238, 238),
					line = Color3.fromRGB(220, 220, 220),
					text = Color3.fromRGB(25, 25, 25),
					dim = Color3.fromRGB(85, 85, 85),
					mute = Color3.fromRGB(130, 130, 130),
					accent = Color3.fromRGB(45, 120, 220),
					accentDeep = Color3.fromRGB(215, 228, 245),
					accentHover = Color3.fromRGB(70, 140, 235),
					ink = Color3.fromRGB(255, 255, 255),
					ok = Color3.fromRGB(55, 150, 95),
					Kira = Color3.fromRGB(20, 20, 20)
				},
				Light = {
					bg = Color3.fromRGB(248, 248, 248),
					rail = Color3.fromRGB(255, 255, 255),
